        ...
        {error && (
          <div className="mb-6 bg-gradient-to-r from-red-50 to-rose-50 border border-red-200 rounded-2xl shadow-lg overflow-hidden">
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">Error loading notifications: {error}</p>
              <button
              ...
              <div className="p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">Filter & Actions</h2>
                  </div>
              ...
              {filteredNotifications.length === 0 ? (
                ...
                filteredNotifications.map((notification) => (
                  <div
                    ...
                    className={`bg-white rounded-2xl shadow-lg border-l-4 ${getNotificationBorderColor(notification.type)} overflow-hidden transition-all duration-200 hover:shadow-xl ${
                      notification.read ? 'border-gray-100' : 'border-blue-200 bg-gradient-to-r from-blue-50/30 to-white'
                    }`}
                  >
                    <div className="p-6">

          ...
          >
            {isEditing ? (
              ...
              <motion.button
                ...
                className="px-7 py-2 bg-gradient-to-r from-blue-600 to-purple-600  hover:bg-gradient-to-r from-blue-700 to-purple-700  text-white font-semibold rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300 cursor-pointer"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                Edit
